...
<head>
    ...
    <link href="login/css/stylesToggleLogin.css" rel="stylesheet" />
...
<body id="page-top">
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Projeto que visa conectar clientes e prestadores de serviços</h1>
                    <hr class="divider" />
                </div>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white mt-0">Anuncio</h2>
    ...
    <section class="page-section" id="services">
        <div class="container px-4 px-lg-5">
            <h2 class="text-center mt-0">Serviços que podem ser encontrados</h2>
            <hr class="divider" />
